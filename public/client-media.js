import { VidstackPlayer } from 'https://cdn.vidstack.io/player'
import { mediaShellElement, resetMediaShell, showCaption, showIdentity } from './client-dom.js'
	...
	return {
		...
		async renderItem(item) {
			...
			if (item.type.startsWith('audio/') || item.type.startsWith('video/')) {
				...
				if (!player || sessionId !== activePlayerSession || item.id !== currentItemId) {
					return
				}
