...
app.get('/client-connection.js', (c) => servePublicAsset(c, 'client-connection.js'))
app.get('/client-dom.js', (c) => servePublicAsset(c, 'client-dom.js'))
app.get('/client-media.js', (c) => servePublicAsset(c, 'client-media.js'))
