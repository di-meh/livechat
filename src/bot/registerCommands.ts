...
export async function registerCommands(commands: Collection<string, BotCommand>): Promise<void> {
	...
	if (process.env.DISCORD_GUILD_ID) {
		await rest.put(Routes.applicationGuildCommands(discordClientId, process.env.DISCORD_GUILD_ID), {
			body
		})
		return
	}
