...
type _CoercedEnvSchema_aebe9e78 = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_aebe9e78> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_aebe9e78, 'PORT' | 'DISCORD_CLIENT_ID' | 'DISCORD_GUILD_ID'>> {}
}
...
type _EnvSchemaAsStrings_aebe9e78 = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_aebe9e78 {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_aebe9e78 {}
  }
}